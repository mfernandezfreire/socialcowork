...
import "../allprojects/Allprojects.scss";
      ...
      <div className="Allprojects-characteristics">
        <div className="Allprojects-charateristics-img">
          ...
          <ul>
            ...
            <li><h3 className="alert" >{this.state.error ? "Ahora sigues el proyecto" : ""}</h3>
              <form  onSubmit={e => this.handleFormSubmit(e)}>
                {/* <input
                  ...
                  /> */}
                <input className="button-follow" type="submit" value="SIGUE EL PROYECTO" />
              </form></li>
              </ul> 
        </div>
      </div>
